...
const people = [
  { id: 1, name: "Nigeria" },
  { id: 2, name: "Other country or region" },
];
...
export default function LocalDropdown() {
  ...
  return (
    <Combobox value={selected} onChange={setSelected}>
      <div className="relative mt-1 pl-8 w-96">
        <div className="relative w-full cursor-default overflow-hidden rounded-lg text-left shadow-md sm:text-sm">
          ...
          <Combobox.Input
            className="w-full border-none py-2 pl-12 pr-10 text-sm leading-5 text-white bg-slate-50/[0.16]"
